...
function PositioningSignals(){
  ...
  const data=[
    ...
    ["↗",tx(lang,"GROWTH & IMPACT","WACHSTUM & WIRKUNG","CROISSANCE & IMPACT","CRECIMIENTO & IMPACTO","增长与影响"),tx(lang,"Strategy that works. Measurable. Sustainable.","Strategie, die wirkt. Messbar. Nachhaltig.","Une stratégie qui agit. Mesurable. Durable.","Estrategia que funciona. Medible. Sostenible.","有效战略。可衡量。可持续。")]
  ];
